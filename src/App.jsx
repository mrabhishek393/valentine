...
import { motion, AnimatePresence } from 'framer-motion'; // Importing at the top
...
function App() {
  ...
  const handleEntry = () => {
    ...
    if (audioRef.current) {
      ...
      setTimeout(() => setShowMusicControl(true), 500);
    }
  };
  ...
  return (
    <div className="App font-sans text-gray-800 antialiased overflow-x-hidden">
      <AnimatePresence mode="wait">
        {!entered && <LandingPage onOpen={handleEntry} />}
      </AnimatePresence>
      ...
      {/* Floating Music Player - Show after landing page and autoplay starts */}
      {entered && showMusicControl && (
        <div
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-xs font-bold text-pink-600">{isPlaying ? 'Now Playing' : 'Paused'}</span>
